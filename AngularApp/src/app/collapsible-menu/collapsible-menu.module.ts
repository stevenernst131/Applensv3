...
import { CollapsibleMenuItemComponent, SearchPipe } from './components/collapsible-menu-item/collapsible-menu-item.component';
...
@NgModule({
  ...
  declarations: [CollapsibleMenuComponent, CollapsibleMenuItemComponent, SectionDividerComponent, SearchBoxComponent, MenuScrollComponent, SearchPipe],
